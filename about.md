---
layout: page
title: "Sobre mí — Marisa Alemany"
description: "Consultora freelance experta en Gestión del Dato (CDMP), especializada en Gobierno del Dato, Calidad del Dato, Metadata y Arquitectura de la Información. Más de diez años de experiencia ayudando a organizaciones a gestionar y gobernar su información."
---
...
Creo en un enfoque **ético, integrador y práctico** del dato: la tecnología solo tiene sentido si mejora las decisiones humanas.

---

## 📚 Certificaciones y especialización
- **CDMP (Certified Data Management Professional)**  
- Experta en el marco **DAMA-DMBOK2**  
- Gobierno del Dato, Calidad del Dato, Metadata Management
- Integración e Interoperabilidad 
- Estrategia y Cultura del Dato  
- Data Fabric y Arquitectura de la Información  

---

## 💬 Filosofía de trabajo
Mi misión es ayudar a las organizaciones a **entender, estructurar y aprovechar sus datos** como activos estratégicos.  
Acompaño los proyectos desde la definición del modelo de gobierno hasta la implantación técnica y la adopción cultural.
